...
describe('#breedDetails', () => {
  ...
  it("returns 'No breed name entered.' when no breed given", () => {
    const expectedDesc = 'No breed name entered.';
    const noBreedGiven = breedDetails('');
    assert.equal(expectedDesc, noBreedGiven);
  });
});